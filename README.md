...
### Pasos
1) Crear fork de https://github.com/gitt-3-pat/p1 en mi cuenta de github. Esto descarga un respositorio copia no vinculado al original.
2) Clonar el [repositorio fork de p1](https://github.com/i-gh-OS/p1-fork) en local (o codespace).
...
3) Averiguar el estado actual del repositorio p1-fork usando ``git status``
    Puesto que no hemos modificado nada, nos sale el siguiente log:
    ![alt text](logStatus1.png)
4) Mientras se realizaba la practica, se ha ido actualizando la memoria y se han incorporado dos archivos .png al repositorio. Escribiendo nuevamente el comando ``git status`` observamos el siguiente log que nos indica que hay archivos sin traquear y que el archivo [README.md](C:\Users\irene\OneDrive - Universidad Pontificia Comillas\3ºGITTBA\PAT\T0_Git\p1-fork\README.md) sobre el que estamos escribiendo se ha modifcado:
